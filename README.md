...
|2|[markdown-badges](https://github.com/Ileriayo/markdown-badges.git)|Badges for your Profile and Projects.|2359|markdown-badges, github-profile-readme, github-profile, hacktoberfest|28-11-2021|  
|3|[ant-design](https://github.com/ant-design/ant-design.git)|An enterprise-class UI design language and React UI library|76038|react, ui-kit, typescript, antd, ant-design, design-systems, ui-library|5-12-2021|  
...
|7|[dayjs](https://github.com/iamkun/dayjs.git)|⏰ Day.js 2kB immutable date-time library alternative to Moment.js with the same modern API|37256|time, date, date-formatting, datetime, moment, dayjs|29-11-2021|  
...
|10|[clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript.git)|:bathtub: Clean Code concepts adapted for JavaScript|60623|javascript, principles, composition, inheritance, clean-code, clean-architecture, best-practices|23-5-2021|  
...
|17|[nvm](https://github.com/nvm-sh/nvm.git)|Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions|53593|nvm, nodejs, node, node-js, version-manager, posix, posix-compliant, bash, zsh, shell, nvmrc, lts, install|3-12-2021|  
...
|22|[core-js](https://github.com/zloirock/core-js.git)|Standard Library|15767|proposal, polyfill, shim, es6, promise, weakmap, es7, es2015, esnext, symbol, ponyfill, es2019, javascript, js, ecmascript-proposals, proposals|5-12-2021|  
...
|32|[bit](https://github.com/teambit/bit.git)|A tool for component-driven application development. |14389|react, javascript, typescript, front-end, node-js, reactjs-components, vue, collaboration, angular, component-driven, component-driven-design, distributed, polyrepo, monorepo|5-12-2021|  
|33|[ngx-speculoos](https://github.com/Ninja-Squad/ngx-speculoos.git)|Simpler, cleaner Angular unit tests |57||4-12-2021|  
|34|[nvm-windows](https://github.com/coreybutler/nvm-windows.git)|A node.js version management utility for Windows. Ironically written in Go.|18369|node, versioning, management, version-manager, windows, nodejs, version, nvm, go, switch|12-11-2021|  
|35|[material-ui](https://github.com/mui-org/material-ui.git)|MUI (formerly Material-UI) is the React UI library you always wanted. Follow your own design system, or start with Material Design.|73441|react-components, react, javascript, material-design, design-systems, typescript, hacktoberfest|5-12-2021|  
...
|37|[flutter](https://github.com/flutter/flutter.git)|Flutter makes it easy and fast to build beautiful apps for mobile and beyond|132882|mobile, android, ios, material-design, dart, skia, web, web-framework, windows, macos, fuchsia, dart-platform, linux-desktop, app-framework, desktop|5-12-2021|  
...
|40|[axe-core](https://github.com/dequelabs/axe-core.git)|Accessibility engine for automated Web UI testing|4272|hacktoberfest, axe, a11y, accessibility|30-11-2021|  
...
|52|[axios](https://github.com/axios/axios.git)|Promise based HTTP client for the browser and node.js|89607|http-client, javascript, nodejs, promise, hacktoberfest|16-11-2021|  
...
|54|[create-react-app](https://github.com/facebook/create-react-app.git)|Set up a modern web app by running one command.|91806|react, zero-configuration, build-tools|3-12-2021|  
...
|57|[API-Security-Checklist](https://github.com/shieldfy/API-Security-Checklist.git)|Checklist of the most important security countermeasures when designing, testing, and releasing your API|16289|api, security, jwt, oauth2|31-5-2021|  
...
|59|[primeng](https://github.com/primefaces/primeng.git)|The Most Complete Angular UI Component Library|7161|angular, ui, components, datatable, datagrid, charts, typescript, mit|3-12-2021|  
...
|73|[http-server](https://github.com/http-party/http-server.git)|a simple zero-configuration command-line http server|11252|http, static, hosting, server, command-line, hacktoberfest|19-10-2021|  
...
|85|[components](https://github.com/angular/components.git)|Component infrastructure and Material Design components for Angular|22337|angular, material-design, material, angular-components|3-12-2021|  
...
|89|[free-for-dev](https://github.com/ripienaar/free-for-dev.git)|A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev|51339||4-12-2021|  
...
|93|[material-design-icons](https://github.com/google/material-design-icons.git)|Material Design icons by Google|44465|material, material-design, icons, sprites, ios, android, web|15-11-2021|  
...
|99|[electron](https://github.com/electron/electron.git)|:electron: Build cross-platform desktop apps with JavaScript, HTML, and CSS|99216|electron, javascript, c-plus-plus, html, css, chrome, nodejs, v8, works-with-codespaces|3-12-2021|  
|100|[lab](https://github.com/dgageot/lab.git)|Lab Modern Web With Java Devoxx Franc 2014|5||10-9-2014|  
|101|[free-programming-books](https://github.com/EbookFoundation/free-programming-books.git)|:books: Freely available programming books|213992|education, books, list, resource, hacktoberfest|29-11-2021|  
