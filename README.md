...
|10|[clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript.git)|:bathtub: Clean Code concepts adapted for JavaScript|60613|javascript, principles, composition, inheritance, clean-code, clean-architecture, best-practices|23-5-2021|  
...
|34|[nvm-windows](https://github.com/coreybutler/nvm-windows.git)|A node.js version management utility for Windows. Ironically written in Go.|18361|node, versioning, management, version-manager, windows, nodejs, version, nvm, go, switch|12-11-2021|  
...
|38|[immutability-helper](https://github.com/kolodny/immutability-helper.git)|mutate a copy of data without changing the original source|4777||15-10-2020|  
...
|73|[http-server](https://github.com/http-party/http-server.git)|a simple zero-configuration command-line http server|11250|http, static, hosting, server, command-line, hacktoberfest|19-10-2021|  
...
|101|[free-programming-books](https://github.com/EbookFoundation/free-programming-books.git)|:books: Freely available programming books|213752|education, books, list, resource, hacktoberfest|29-11-2021|  
